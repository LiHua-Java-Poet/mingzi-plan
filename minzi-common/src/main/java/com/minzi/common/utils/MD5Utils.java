...
public class MD5Utils {
     ...
     * @return 密文
     */
    public String generaEncryptPassword(String password, String saltValue) {
        return MD5Upper(password, saltValue);
    }
     ...
     * @param password  密码
     * @param saltValue 盐值
     * @param realityPassword 数据库密码
     * @return 判断结果
     */
    public Boolean examinePassword(String password, String saltValue, String realityPassword) {
        String encryptStr = MD5Upper(password, saltValue);
        return realityPassword.equals(encryptStr);
    }
